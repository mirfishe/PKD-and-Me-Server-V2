...
router.get("/item", (request, response) => {
  ...
  //  getItemsRequest["ItemIds"] = ["B00K4PWS2Y", "1886404100", "B00KK33W0W", "B00FRJXO3E", "B00KN1CHG6", "1629236578", "1463896794", "1987781619", "B0197858WA", "B015XIE47S"];
  ...
  //  getItemsRequest["ItemIds"] = ["0990573370", "B01M0R96OL", "B07ZHNRRGS", "B08QRKV8GW", "B09422NMGD", "B08R1DD383", "162963883", "0765316919", "076531696X", "057513271X"];
  ...
  //  getItemsRequest["ItemIds"] = ["B00FRJXO3E", "B00KN1CHG6", "1629236578", "1463896794", "1987781619", "B0197858WA", "B015XIE47S", "099330608X", "B07JH58YSV", "1478101946"];
  ...
  //  getItemsRequest["ItemIds"] = ["B08QRKV8GW", "B09422NMGD", "B08R1DD383", "162963883"];
...
*/
  ...
  function onSuccess(data) {
    ...
    if (isEmpty(getItemsResponse["ItemsResult"]) === false) {
      ...
      for (let i in getItemsRequest["ItemIds"]) {
        ...
        if (getItemsRequest["ItemIds"].hasOwnProperty(i)) {
          ...
          let itemObject = { searchCategory: "Get Item", totalResultCount: totalResultCount, searchURL: searchURL, page: 0, searchIndex: "Get Item", sortBy: "Get Item", merchant: merchant };
    ...
    if (isEmpty(getItemsResponse["Errors"]) === false) {
      ...
      console.error(`${controllerName}-controller`, getDateTime(), `get / ${tableName}`, JSON.stringify({ searchCategory: searchCategory, searchIndex: searchIndex, sortBy: sortBy }), "Complete Error Response: " + JSON.stringify(getItemsResponse["Errors"], null, 1));

      addErrorLog(`${controllerName}-controller`, "get / getItemsResponse[\"Errors\"]", JSON.stringify({ searchCategory: searchCategory, searchIndex: searchIndex, sortBy: sortBy }), JSON.stringify(getItemsResponse["Errors"], null, 1));
